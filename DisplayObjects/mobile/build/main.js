...
var ProgressPage = (function (_super) {
    ...
    ProgressPage.prototype.CTS1505814542210 = function (event) {
        ...
        this.loading = this.getInstance(__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* LoadingController */]).create({
...
var DocumentsPage = (function (_super) {
    ...
    function DocumentsPage(routerProvider, navParams, loadingCtrl, sanitizer, ref, injector, menuCtrl) {
        ...
        _this.searchbar = '';
        /*Begin_c8o_PageConstructor*/
        _this.platform = _this.getInstance(__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["o" /* Platform */]);
        ...
        _this.toastCtrl = _this.getInstance(__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["q" /* ToastController */]);
